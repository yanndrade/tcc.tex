...
\usepackage[nogroupskip,nonumberlist,acronym]{glossaries}   % Permite fazer o glossario (e lista de siglas)
...
\usepackage{pdflscape}        % Permite páginas em modo paisagem
\usepackage[section]{placeins} % Mantém figuras e tabelas dentro de suas seções
