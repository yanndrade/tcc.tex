...
\autor{Yann Bruno Andrade Mello}
\titulo{Geração de Memoriais de Cálculo Elétrico Residencial via Agentes LLM e RAG: Uma Abordagem Baseada na NBR 5410}
\data{2026}
\local{Fortaleza}
...
\orientador{Prof. Dr. Dalton Honório de Araújo}
...
\coorientador{Prof. Me. Paulo Honório Filho}
...
\membrodabancadois{Prof. Dr. Ronny Glauber de Almeida Cacau}
...
\begin{document}	
	...
	\imprimirfichacatalografica{lib/ficha-catalografica}
